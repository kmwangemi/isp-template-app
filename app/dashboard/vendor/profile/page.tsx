...
import { vendorProfileUpdateSchema, passwordChangeSchema } from '@/lib/schemas/profile';
    ...
    <div className="p-4 sm:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage your business information and settings</p>
        </div>
      </div>
            ...
            <Form {...infoForm}>
              <form onSubmit={infoForm.handleSubmit(onInfoSubmit)} className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Access your dashboard at: https://{field.value}.hotspotmanager.com
                      </p>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="border-t border-border pt-6">
                  <h3 className="text-sm font-semibold mb-4">Administrator Information</h3>
            ...
            <Dialog>
              ...
              <DialogContent className="bg-card border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Are you sure you want to log out? You can log back in anytime with your credentials.
                </p>
